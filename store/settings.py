...
SECRET_KEY = 'django-insecure-tvh#pa93&a1#o++hi_s+3app!^6kovz8u7#3+5u=z-qs-6%vvm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["farm-produce-ten.vercel.app"]
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # For project-wide static files (create a 'static' folder next to manage.py)
]
